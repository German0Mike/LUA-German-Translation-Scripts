...
╚══════════════════════════════════════════╝
--]]
  print("->LUA-Skript: Ruhesteinteleporter...geladen!")
    local itemid =6948
    function Tele_Book(event, player, item)
            if (player:IsInCombat() == true) then
                    player:SendAreaTriggerMessage("In einem Kampf ist dies nicht möglich!")
            else
    ...
    player:GossipMenuAddItem(6, "|cFF191970Hauptstädte|r", 0,  1)
    player:GossipMenuAddItem(2, "|cFF191970Azeroth|r", 0,  2)
    player:GossipMenuAddItem(2, "|cFF191970Azeroth Instanzen|r", 0,  3)
    player:GossipMenuAddItem(2, "|cFF191970Azeroth Schlachtzüge|r", 0,  4)
    player:GossipMenuAddItem(2, "|cFF191970Scherbenwelt|r", 0,  5)
    player:GossipMenuAddItem(2, "|cFF191970Scherbenwelt Instanzen|r", 0,  6)
    player:GossipMenuAddItem(2, "|cFF191970Scherbenwelt Schlachtzüge|r", 0,  7)
    player:GossipMenuAddItem(2, "|cFF191970Nordend|r", 0,  8)
    player:GossipMenuAddItem(2, "|cFF191970Nordend Instanzen|r", 0,  9)
    player:GossipMenuAddItem(2, "|cFF191970Nordend Schlachtzüge|r", 0,  10)
    player:GossipMenuAddItem(9, "|cFF191970Spielertreff|r", 0,  13)
    player:GossipMenuAddItem(0, "|cFF191970Nächste Seite|r", 0,  997)
    ...
    if (intid == 997) then -- Home Page Cont.
            player:GossipMenuAddItem(5, "|cFF191970Shattrath|r", 0,  11)
    ...
    if (intid == 1) then -- Alliance Cities
            if (plyr == 1) or (plyr == 3) or (plyr == 4) or (plyr == 7) or (plyr == 11) then
                    player:GossipMenuAddItem(2, "|c00FF0000Sturmwind|r", 0,  19)
                    player:GossipMenuAddItem(2, "|c00FF0000Eisenschmiede|r", 0,  20)
                    player:GossipMenuAddItem(2, "|c00FF0000Darnassus|r", 0,  21)
                    player:GossipMenuAddItem(2, "|c00FF0000Exodar|r", 0,  22)
                    player:GossipMenuAddItem(0, "|c99006600Zurück|r", 0,  999)
                    player:GossipSendMenu(1, item)
            end
                                    -- Horde Cities
            if (plyr == 2) or (plyr == 5) or (plyr == 6) or (plyr == 8) or (plyr == 10) then
                    player:GossipMenuAddItem(2, "|c00FF0000Orgimmar|r", 0,  23)
                    player:GossipMenuAddItem(2, "|c00FF0000Donnerfels|r", 0,  24)
                    player:GossipMenuAddItem(2, "|c00FF0000Unterstadt|r", 0,  25)
                    player:GossipMenuAddItem(2, "|c00FF0000Silbermond|r", 0,  26)
                    player:GossipMenuAddItem(0, "|c99006600Zurück|r", 0,  999)
                    player:GossipSendMenu(1, item)
            end
    end
    ...
    if (intid == 2) then -- Azeroth Continets
            ...
            player:GossipMenuAddItem(2, "|c00FF0000Östliche Königreiche|r", 0,  27)
    ...
    if (intid == 3) then -- Azeroth Instances
            player:GossipMenuAddItem(2, "|c00FF0000Schwarzfelstiefe[52-60]|r", 0,  29)
            player:GossipMenuAddItem(2, "|c00FF0000Schwarzfelsspitze[55-60]|r", 0,  30)
            player:GossipMenuAddItem(2, "|c00FF0000Düsterbruch[44-54]|r", 0,  31)
            player:GossipMenuAddItem(2, "|c00FF0000Gnomeregan[26-36]|r", 0,  32)
            player:GossipMenuAddItem(2, "|c00FF0000Maraudon[42-52]|r", 0,  33)
            if (plyr == 2) or (plyr == 5) or (plyr == 6) or (plyr == 8) or (plyr == 10) then
                    player:GossipMenuAddItem(2, "|c00FF0000Flammenschlund[15-25]|r", 0,  34)
            end
            player:GossipMenuAddItem(2, "|c00FF0000Die Hügel von Razorfen[32-42]|r", 0,  35)
            player:GossipMenuAddItem(2, "|c00FF0000Der Kral von Razorfen[37-47]|r", 0,  36)
            player:GossipMenuAddItem(2, "|c00FF0000Das scharlachrote Kloster[26-45]|r", 0,  37)
            player:GossipMenuAddItem(2, "|c00FF0000Scholomance[55-60]|r", 0,  38)
            player:GossipMenuAddItem(2, "|c00FF0000Burg Shattenfang[22-30]|r", 0,  39)
            player:GossipMenuAddItem(2, "|c00FF0000Stratholme[48-58]|r", 0,  40)
            player:GossipMenuAddItem(2, "|c00FF0000Versunkener Tempel[50-60]|r", 0,  41)
            player:GossipMenuAddItem(2, "|c00FF0000Todesminen[15-24]|r", 0,  42)
            if (plyr == 1) or (plyr == 3) or (plyr == 4) or (plyr == 7) or (plyr == 11) then
                    player:GossipMenuAddItem(2, "|c00FF0000The Stockade|r", 0,  43)
            end
            player:GossipMenuAddItem(0, "|c99006600Nächste Seite|r", 0,  994)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0,  999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 994) then -- Azeroth Instances Cont.
            player:GossipMenuAddItem(2, "|c00FF0000Uldaman[42-52]|r", 0,  44)
            player:GossipMenuAddItem(2, "|c00FF0000Die Höhlen des Wehklagens[17-27]|r", 0,  45)
            player:GossipMenuAddItem(2, "|c00FF0000Zul'Farrak[46-56]|r", 0,  46)
            player:GossipMenuAddItem(0, "|c99006600Nächste Seite|r", 0,  3)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0,  999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 4) then -- Azeroth Raids
            player:GossipMenuAddItem(2, "|c00FF0000Pechschwingenhort[Tier 2]|r", 0,  47)
            player:GossipMenuAddItem(2, "|c00FF0000Geschmolzener Kern[Tier 1]|r", 0,  48)
            player:GossipMenuAddItem(2, "|c00FF0000Onyxia's Kammer[Tier 9 - 60 und80er Version]|r", 0,  49)
            player:GossipMenuAddItem(2, "|c00FF0000Ruinen von Ahn\'Qiraj[Tier 0.5]|r", 0,  50)
            player:GossipMenuAddItem(2, "|c00FF0000Tempel von Ahn\'Qiraj[Tier 3]|r", 0,  51)
            player:GossipMenuAddItem(2, "|c00FF0000Zul'Gurub[Tier 0.5]|r", 0, 52)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0,  999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 5) then -- Outland Locations
            player:GossipMenuAddItem(2, "|c00FF0000Schergrat[65-68]|r", 0,  53)
            player:GossipMenuAddItem(2, "|c00FF0000Höllenfeuer Halbinsel[58-63]|r", 0,  54)
            player:GossipMenuAddItem(2, "|c00FF0000Nagrand[64-67]|r", 0,  55)
            player:GossipMenuAddItem(2, "|c00FF0000Netherstorm[67-70]|r", 0,  56)
            player:GossipMenuAddItem(2, "|c00FF0000Schattenmondtal[67-70]|r", 0,  57)
            player:GossipMenuAddItem(2, "|c00FF0000Wald von Terokkar[62-65]|r", 0,  58)
            player:GossipMenuAddItem(2, "|c00FF0000Zangarmarschen[60-64]|r", 0,  59)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0,  999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 6) then -- Outland Instances
            player:GossipMenuAddItem(2, "|c00FF0000Auchindoun[62-75]|r", 0,  60)
            player:GossipMenuAddItem(2, "|c00FF0000Höhlen der Zeit[62-75]|r", 0,  61)
            player:GossipMenuAddItem(2, "|c00FF0000Sklavenunterkünfte[62-75]|r", 0,  62)
            player:GossipMenuAddItem(2, "|c00FF0000Höllenfeuer Zitadelle[62-75]|r", 0,  63)
            player:GossipMenuAddItem(2, "|c00FF0000Terrasse der Magister[62-75]|r", 0,  64)
            player:GossipMenuAddItem(2, "|c00FF0000Festung der Stürme[62-75]|r", 0,  65)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0,  999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 7) then -- Outland Raids
            player:GossipMenuAddItem(2, "|c00FF0000Schwarzer Tempel[Tier 6]|r", 0,  66)
            player:GossipMenuAddItem(2, "|c00FF0000Hyjalgipfel[Tier 6]|r", 0,  67)
            player:GossipMenuAddItem(2, "|c00FF0000Höhle des Schlangenschreins[Tier 5]|r", 0,  68)
            player:GossipMenuAddItem(2, "|c00FF0000Gruul's Kammer[Tier 4]|r", 0,  69)
            player:GossipMenuAddItem(2, "|c00FF0000Magtheridon's Kammer[Tier 4]|r", 0,  70)
            player:GossipMenuAddItem(2, "|c00FF0000Karazhan[Tier 4]|r", 0, 71)
            player:GossipMenuAddItem(2, "|c00FF0000Sonnenbrunnenplateau[Tier 6.5]|r", 0,  72)
            player:GossipMenuAddItem(2, "|c00FF0000Das Auge[Tier 5]|r", 0,  73)
            player:GossipMenuAddItem(2, "|c00FF0000Zul'Aman[Tier 3.5]|r", 0,  74)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0,  999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 8) then -- Northrend Locations
            player:GossipMenuAddItem(2, "|c00FF0000Boreanische Tundra[68-72]|r", 0, 75)
            player:GossipMenuAddItem(2, "|c00FF0000Kristallsangswald[77-80]|r", 0, 76)
            player:GossipMenuAddItem(2, "|c00FF0000Drachenöde[71-74]|r", 0, 77)
            player:GossipMenuAddItem(2, "|c00FF0000Grizzly Hügel[73-75]|r", 0, 78)
            player:GossipMenuAddItem(2, "|c00FF0000Heulender Fjord[68-72]|r", 0, 79)
            player:GossipMenuAddItem(2, "|c00FF0000Eiskrone[77-80]|r", 0, 80)
            player:GossipMenuAddItem(2, "|c00FF0000Sholazarbecken[76-78]|r", 0, 81)
            player:GossipMenuAddItem(2, "|c00FF0000Sturmlande[77-80]|r", 0, 82)
            player:GossipMenuAddItem(2, "|c00FF0000Tausendwintersee[77-80]|r", 0, 83)
            player:GossipMenuAddItem(2, "|c00FF0000Zul'Drak[74-77]r", 0, 84)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0, 999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 9) then -- Northrend Instances
            player:GossipMenuAddItem(2, "|c00FF0000Azjol-Nerub[70-80]|r", 0, 85)
            player:GossipMenuAddItem(2, "|c00FF0000Drak'Tharon Spitze[79-80]|r", 0, 86)
            player:GossipMenuAddItem(2, "|c00FF0000Gundrak[76-78]|r", 0, 87)
            player:GossipMenuAddItem(2, "|c00FF0000Das Ausmerzen von Stratholme[79-80]|r", 0, 88)
            player:GossipMenuAddItem(2, "|c00FF0000Die Halle der Blitze[79-80]|r", 0, 89)
            player:GossipMenuAddItem(2, "|c00FF0000Die Halle der Steine[77-80]|r", 0, 90)
            player:GossipMenuAddItem(2, "|c00FF0000Der Nexus|r", 0, 91)
            player:GossipMenuAddItem(2, "|c00FF0000Tie Violette Festung|r", 0, 92)
            player:GossipMenuAddItem(2, "|c00FF0000Burg Utgarde[70-72]|r", 0, 93)
            player:GossipMenuAddItem(2, "|c00FF0000Turm Utgarde[79-80]|r", 0, 94)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0, 999)
            player:GossipSendMenu(1, item)
    end
    ...
    if (intid == 10) then -- Northrend Raids
            ...
            player:GossipMenuAddItem(2, "|c00FF0000Das Auge der Ewigkeit[Tier 7]|r", 0, 96)
            player:GossipMenuAddItem(2, "|c00FF0000Das Obsidian Sanktum[Tier 7]|r", 0, 97)
            player:GossipMenuAddItem(2, "|c00FF0000Ulduar[Tier 8]|r", 0, 98)
            player:GossipMenuAddItem(2, "|c00FF0000Archavons Kammer[Tier 7]|r", 0, 99)
            player:GossipMenuAddItem(0, "|c99006600...|r", 0, 999)
            player:GossipSendMenu(1, item)
    end
    ...
    if (intid == 13) then
            player:Teleport(0, -14456.8, 491.761, 15.1251, 0.791434)
            player:GossipComplete()
    end
    ...
    if (intid == 27) then -- Eastern Kingdoms
            player:GossipMenuAddItem(2, "Alteracgebirge[30-40]", 0, 112)
            player:GossipMenuAddItem(2, "Arathi Hochland[30-40]", 0, 113)
            player:GossipMenuAddItem(2, "Ödland[35-45]", 0, 114)
            player:GossipMenuAddItem(2, "Verwüstete Lande[45-55]", 0, 115)
            player:GossipMenuAddItem(2, "Brennende Steppe[50-58]", 0, 116)
            player:GossipMenuAddItem(2, "Todeswindpass", 0, 117)
            player:GossipMenuAddItem(2, "Dun Morogh[1-10]", 0, 118)
            player:GossipMenuAddItem(2, "Dämmerwald[18-30]", 0, 119)
            player:GossipMenuAddItem(2, "Östliche Pestländer[53-60]", 0, 120)
            player:GossipMenuAddItem(2, "Wald von Elwyn[1-10]", 0, 121)
            player:GossipMenuAddItem(2, "Immersangswald[1-10]", 0, 122)
            player:GossipMenuAddItem(2, "Geisterlande[10-20]", 0, 123)
            player:GossipMenuAddItem(2, "Vorgebirge des Hügelland[20-30]", 0, 124)
            player:GossipMenuAddItem(2, "Insel von Quel Danas[69-70]", 0, 125)
            player:GossipMenuAddItem(0, "Nächste Seite", 0, 996)
            player:GossipMenuAddItem(0, "...", 0, 999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 996) then -- Eastern Kingdoms Cont.
            player:GossipMenuAddItem(2, "Loch Modan[10-20]", 0, 126)
            player:GossipMenuAddItem(2, "Rotkamm Gebirge[15-25]", 0, 127)
            player:GossipMenuAddItem(2, "Sengende Schlucht[43-50]", 0, 128)
            player:GossipMenuAddItem(2, "Silberwald[10-20]", 0, 129)
            player:GossipMenuAddItem(2, "Schlingendorntal[30-45]", 0, 130)
            player:GossipMenuAddItem(2, "Sümpfe des Elends[35-45]", 0, 131)
            player:GossipMenuAddItem(2, "Die Hinterlande[40-50]", 0, 132)
            player:GossipMenuAddItem(2, "Trisfall[1-10]", 0, 133)
            player:GossipMenuAddItem(2, "Westliche Pestländer[51-58]", 0, 134)
            player:GossipMenuAddItem(2, "Westfall[10-20]", 0, 135)
            player:GossipMenuAddItem(2, "Sumpfland[20-30]", 0, 136)
            player:GossipMenuAddItem(0, "Zurück", 0, 27)
            player:GossipMenuAddItem(0, "...", 0, 999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 28) then -- Kalimdor
            player:GossipMenuAddItem(2, "Eschental[18-30]", 0, 137)
            player:GossipMenuAddItem(2, "Azshara[45-55]", 0, 138)
            player:GossipMenuAddItem(2, "Azuremyst Insel[1-10]", 0, 139)
            player:GossipMenuAddItem(2, "Bloodmyst Insel[1-10]", 0, 140)
            player:GossipMenuAddItem(2, "Dunkelküste[10-20]", 0, 141)
            player:GossipMenuAddItem(2, "Desolace[30-40]", 0, 142)
            player:GossipMenuAddItem(2, "Durotar[1-10]", 0, 143)
            player:GossipMenuAddItem(2, "Düstermarschen[35-45]", 0, 144)
            player:GossipMenuAddItem(2, "Teufelswald[48-55]", 0, 145)
            player:GossipMenuAddItem(2, "Feralas[40-50]", 0, 146)
            player:GossipMenuAddItem(2, "Moonglade[?}", 0, 147)
            player:GossipMenuAddItem(2, "Mulgore[1-10]", 0, 148)
            player:GossipMenuAddItem(2, "Silithus[55-60]", 0, 149)
            player:GossipMenuAddItem(0, "Nächste Seite", 0, 995)
            player:GossipMenuAddItem(0, "...", 0, 999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 995) then -- Kalimdor Cont.
            player:GossipMenuAddItem(2, "Steinkrallengebirge[15-27]", 0, 150)
            player:GossipMenuAddItem(2, "Tanaris[40-50]", 0, 151)
            player:GossipMenuAddItem(2, "Teldrassil[1-10]", 0, 152)
            player:GossipMenuAddItem(2, "Brachland[10-25]", 0, 153)
            player:GossipMenuAddItem(2, "Tausend Nadeln[24-35]", 0, 154)
            player:GossipMenuAddItem(2, "Krater von Un'Goro[48-55]", 0, 0, 155)
            player:GossipMenuAddItem(2, "Winterspring[55-60]", 0, 156)
            player:GossipMenuAddItem(0, "Zurück", 0, 28)
            player:GossipMenuAddItem(0, "...", 0, 999)
            player:GossipSendMenu(1, item)
    end
