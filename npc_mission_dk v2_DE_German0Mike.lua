...
print("->LUA-Skript: Todesrittergebiet ueberspringen...geladen!")
------------------------------------------------------------------------------------------------
...
local function announceZone(player)
    ...
    for _,p in pairs(players) do
        p:SendBroadcastMessage("[|cff4CFF00Das Todesrittergebiet wurde übersprungen von|r] "..icon.." |Hplayer:"..name.."|h[|cffc41f3b"..name.."|r]|h ist nun fertig hier und wird wegteleportiert.")
    end
end
...
local function skipDKStarter(player)
    ...
    if(freeSlots < 21) then
        player:SendBroadcastMessage("[|cff4CFF00[Skript]Todesrittergebiet überspringen|r] |cffff2020Du brauchst mindesten 21 Platz in deinem Beutel.r")
        player:SendBroadcastMessage("[|cff4CFF00[Skript]Todesrittergebiet überspringen|r] Du hast gerade einmal "..freeSlots.." feie Plätz in deinem Beutel, Du brauchst "..(21-freeSlots).." mehr")
        player:SendNotification("Du brauchst noch "..(21-freeSlots).." freie Plätze in deinem Beutel um hier aufzuhören")
        return
    end
...
if (AnnounceModule and not GM_Only) then
    RegisterPlayerEvent(3, function(event,player)
        player:SendBroadcastMessage("|cff4CFF00[Skript]Todesrittergebiet überspringen.")
